                                    ...
                                    <div class="card mb-0">
                                        ...
                                        <div class="card-body m-1  h-480px p-0 px-3 py-2 overflow-auto">
                                            ...
                                            <div class="">
                                                <div class="row mt-2">
                                                    <div class="col-lg-8">
                                                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRo49AwRQ-h0TKYFsUhF77v1h5ibXnT5i7q-QfdWRA78I5kKbRs7-SXxXl2wkxkbMJrtoI&usqp=CAU" class="img-fluid" alt="">
                                                    </div>
                                                        ...
                                                        <div class="col-12 px-3 py-2">
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-label" for="answer1s">
                                                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRo49AwRQ-h0TKYFsUhF77v1h5ibXnT5i7q-QfdWRA78I5kKbRs7-SXxXl2wkxkbMJrtoI&usqp=CAU" width="150px" height="150px" alt="">
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 px-3 py-2">
