...
<body data-sidebar="dark">
                                        ...
                                        <div class="row bg-light border-bottom">
                                            ...
                                            <div class="col-md-3 col-4">
                                                <div class="d-flex  float-end mt-2">
                                                    ...
                                                    <div class="ms-2">
                                                        <span class="badge bg-medium-secondary text-danger fs-6">Section
                                                            Time left
                                                                    ...
                                                                    <div class="card-body bg-light">
                                                                        <div class="row">
                                                                            <div class="col-12 d-flex justify-content-center">
                                                                                <button class="btn btn-danger" id="backspace">Backspace</button>
                                                                            </div>
                                                                            <div class="col-12 d-flex justify-content-center">
                                                                                <div class="mt-3">
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="1">1</button>
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="2">2</button>
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="3">3</button>
                                                                                    <br />
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="4">4</button>
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="5">5</button>
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="6">6</button>
                                                                                    <br />
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="7">7</button>
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="8">8</button>
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="9">9</button>
                                                                                    <br>
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="0">0</button>
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value=".">.</button>
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="-">-</button>
                                                                                    <br />
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="left"><i class="dripicons-arrow-thin-left"></i></button>
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="right"><i class="dripicons-arrow-thin-right"></i></button>
                                                                                    <br />
                                                                                    <button class="btn btn-primary theta_btn my-1" data-value="9" style="width:100px !important;">Clear All</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                ...
                <div>
                    ...
                    <div class="row mt-1 ">
                        ...
                        <div class="col-12 overflow-auto ">
                            ...
                            <div class="d-flex justify-content-center total-question-1 h-300px">
                                <div class="col-12 pt-2">
                                    <a href="mcq.php"><button type="button" class="btn btn-primary active p-0 mb-2">01</button></a>
                                    <a href="paragraph.php"><button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">02</button></a>
                                    <a href="multi-answer.php"> <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">03</button></a>
                                    <a href="fill-in-the-blank.php"><button type="button" class="btn bg-white rounded-0 p-0 mb-2">04</button></a>

                                    <a href="number-question.php"> <button type="button" class="btn bg-white rounded-0 p-0  mb-2">05</button></a>
    ...
    <script>
        $(document).ready(function() {
            $('.theta_btn').click(function() {
                var value = $(this).data('value');
                $('#inputBox').val(function(_, currentValue) {
                    return currentValue + value;
                });
            });
            $('#backspace').click(function() {
                var currentInput = $('#inputBox').val();
                if (currentInput.length > 0) {
                    $('#inputBox').val(currentInput.slice(0, -1));
                }
            });
        });
    </script>
    ...
    <script>
        $(document).ready(function() {
            $('.theta_btn_alpha').click(function() {
                var value = $(this).data('value');
                $('#inputBox1').val(function(_, currentValue) {
                    return currentValue + value;
                });
            });
            $('#backspace1').click(function() {
                var currentInput = $('#inputBox1').val();
                if (currentInput.length > 0) {
                    $('#inputBox1').val(currentInput.slice(0, -1));
                }
            });
        });
    </script>
