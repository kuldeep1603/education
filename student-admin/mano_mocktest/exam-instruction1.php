                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-7">
                                        <div class="p-2">
                                            ...
                                            <span class="badge bg-light fs-6 float-end me- align-middle">Time Left <span
                                ...
                                <div class="row">
                                    <div class="card">
                                        <div class="row bg-light border-bottom">
                                            <div class="col-md-9">
                                                <div class="d-flex p-2">
                                                    ...
                                                    <div class="gap-2">
                                                        <button type="button" class="btn btn-primary btn-sm">Quantative
                                                            Appti..</button>
                                        ...
                                        <div class="d-flex justify-content-center">
                                                <div>
                                                    <span class="fs-5 fw-bold">Exam Instruction</span>
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <ol class="list-group list-group-numbered">
                                                    ...
                                                    <li class="">The clock will be set at the server. The countdown
                                                        timer in the top right corner of
                                                        screen will display the remaining time available for you to
                                                        complete the examination. When
                                                        the timer reaches zero, the examination will end by itself. You
                                                        will not be required to end
                                                        or submit your examination.</li>
                                                    <li class="">The Question Palette displayed on the right side of
                                                        screen will show the status of
                                                        ...
                                                        <ol>
                                                            ...
                                                            <li>You have NOT answered the question, but have marked the
                                                                question for review.</li>
                                                        </ol>
                                                    <li>
                                                        The question(s) "Answered and Marked for Review" will be
                                                        considered for evaluation. The
                                                        Marked for Review status for a question simply indicates that
                                                        you would like to look at that
                                                        question again.
                                                    </li>
                                                    <li class="">You have NOT answered the question, but have marked the
                                                        question for review.</li>
                                                    <li class="">You have NOT answered the question, but have marked the
                                                        question for review.</li>
                                                    <li class="">You have NOT answered the question, but have marked the
                                        ...
                                        <div class="row bg-light p-2">
                                            <div class="d-flex justify-content-between">
                                                <div class="">
                                                    <a href="" class="btn btn-outline-info">Mark for Review & Next</a>
