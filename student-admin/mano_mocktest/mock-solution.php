...
<body data-sidebar="dark">
    ...
    <div id="layout-wrapper">
                ...
                <div class="">
                    <div class="container-fluid bg-white">
                        ...
                        <div class="row ">
                            <div class="col-md-9" id="question_block">
                                ...
                                <div class="row">
                                    <div class="card">
                                        ...
                                        <div class="card-body m-1  h-480px p-0 px-3 py-3 overflow-auto">

                                            <div class="row border-bottom shadow p-0 m-0">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div class="d-flex gap-3">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="badge bg-success rounded-pill pt-1 px-2">Attempted</span>

                                                        </div>

                                                        <div class="border border-danger rounded mb-1 px-1">
                                                            <span class=""><i class="  ri-emotion-unhappy-fill text-danger align-middle fs-6"></i></span>
                                                            <span class="">You:</span>
                                                            <span>00:46</span>

                                                        </div>

                                                        <div class="border border-success rounded mb-1 px-1">
                                                            <span class=""><i class=" ri-emotion-happy-fill text-success align-middle fs-6"></i></span>
                                                            <span class="">You:</span>
                                                            <span>00:25</span>
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="badge bg-success  pt-1 px-2">1</span>
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="badge bg-success  pt-1 px-2">24 % answeres correctly</span>
                                                    ...
                                                    <div class="d-flex float-end gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="badge bg-light p-1">Easy</span>
                                                        </div>
                                            ...
                                            <div>
                                                <div class="mt-2">
                                                    ...
                                                    <form action="">
                                                        <div class="row px-3 py-2 " id="correct_answer">
                                                    ...
                                                    <div class="row mt-4">
                                                        <div>
                                                            <button class="btn btn-outline-info" id="view_solution"> <i class="ri-eye-line align-middle"></i>
                                                                View solution</button>
                                                            <button class="btn btn-outline-info" id="view_solution"> <i class="ri-eye-line align-middle"></i>
                                                                Video</button>
                                                            <span class="ms-2">Click here to see the answer now</span>
                                                        </div>
                                                    </div>

                                                    <div class="row mt-4" id="solution" style="display: none;">
                                                        <div>
                                                            <img src="assets/images/solution-img.png" alt="" class="w-100">
                                                        </div>
                                                ...
                                                <div class="drag-button1" id="drag_button1" style="display: block;">
                                                    <button class="btn bg-dark p-0 py-3 rounded-0"> <i class="ri-arrow-right-s-line align-middle text-white "></i></button>
                                                </div>
                                        ...
                                        <div class="row bg-light p-2">
                                            <div class="d-flex justify-content-between">
                                                <div class="">
                                                    <a href="" class="btn btn-outline-info">Prev</a>
                            ...
                            <div class="col-md-3 bg-light" id="info_sidebar">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <div class="gap-4  mt-4 mb-4">
                            ...
                            <button class="btn btn-info px-2" type="submit">Submit</button>
        ...
        <script>
            ...
            var view_solution = document.getElementById("view_solution");
            ...
            view_solution.addEventListener("click", function() {
                // info_sidebar.style.display="none";

                if (solution.style.display === "none") {
                    solution.style.display = "block";
                    correct_answer.classList.add("bg-success", "text-white");

                } else {
                    solution.style.display = "none";
                    correct_answer.classList.remove("bg-success", "text-white");
