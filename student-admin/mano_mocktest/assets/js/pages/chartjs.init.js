!(function (n) {
  ...
  n(function () {
    ...
    (Chart.defaults.global.defaultFontColor = "#7b919e"),
      ...
      n("#lineChart").length &&
        ((e = n("#lineChart").get(0).getContext("2d")),
        new Chart(e, {
          type: "line",
          data: {
            labels: [
          ...
          options: {
            scales: {
              ...
              xAxes: [
                {
                  gridLines: { display: !1, drawBorder: !1, color: "#ffffff" },
                },
              ],
            },
        ...
        n("#lineChartLR").length &&
        ((e = n("#lineChartLR").get(0).getContext("2d")),
        new Chart(e, {
          type: "line",
          data: {
            labels: [
            ...
            datasets: [
              {
                label: "Marks",
                data: [80, 90, 70,110, 120, 115, 121, 110],
                borderColor: ["#0db4d6"],
                borderWidth: 3,
                fill: !1,
                pointBackgroundColor: "#ffffff",
        ...
        n("#lineChartQADI").length &&
        ((e = n("#lineChartQADI").get(0).getContext("2d")),
        new Chart(e, {
          type: "line",
          data: {
            labels: [
        ...
        n("#lineChartAbstract").length &&
        ((e = n("#lineChartAbstract").get(0).getContext("2d")),
        new Chart(e, {
          type: "line",
          data: {
            labels: [
        ...
        n("#lineChartVARC").length &&
        ((e = n("#lineChartVARC").get(0).getContext("2d")),
        new Chart(e, {
          type: "line",
          data: {
            labels: [
      ...
      n("#barChart").length &&
        ((a = n("#barChart").get(0).getContext("2d")),
        new Chart(a, {
          type: "bar",
          data: {
            labels: [
      ...
      n("#areaChart").length &&
        ((r = n("#areaChart").get(0).getContext("2d")),
        new Chart(r, {
          type: "line",
          data: {
            labels: [
      ...
      areaChart,
      n("#pieChart").length &&
        ((o = n("#pieChart").get(0).getContext("2d")),
        new Chart(o, {
          type: "pie",
          data: {
            datasets: [
      ...
      n("#donut-chart").length &&
        ((o = n("#donut-chart").get(0).getContext("2d")),
        new Chart(o, {
          type: "pie",
          data: {
            datasets: [
      ...
      n("#radar-chart").length &&
        ((t = n("#radar-chart").get(0).getContext("2d")),
        new Chart(t, {
          type: "radar",
          data: {
            datasets: [
