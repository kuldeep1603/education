...
<body data-sidebar="dark">
    ...
    <div id="layout-wrapper">
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-7">
                                        <div class="row pt-2 d-md-flex justify-content-between">
                                            <div class="col-md-9">
                                                <span class="fs-5">MAH MBA CET 2018 Quantitative Aptitude Test</span>
                                            </div>
                                            <div class="col-md-3 d-md-flex align-items-center">
                                                <span class="badge bg-light fs-6 float-md-end me- align-middle">Time
                                                    Left <span
                                                        class="badge bg-secondary me-2 align-middle ms-2">01</span>:<span
                                                        class="badge bg-secondary ms-2 align-middle me-2">58</span>:<span
                                                        class="badge bg-secondary ms-2  align-middle">45</span></span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="card mb-0">
                                            ...
                                            <div class="col-md-3 col-4">
                                                <div class="d-flex  float-end mt-2">
                                                    <div class="">
                                                        ...
                                                        <button class="btn btn-outline-info  btn-sm btn-30px ms-2"><i
                                                                class="fas fa-calculator fs-6"
                                                                id="fa-calculator"></i></button>
                                                    </div>
                                                ...
                                                <div class="drag-button1">
                                                    <div>
                                                        <div class="d-md-block d-none">
                                                            <button class="btn bg-dark p-0 py-3 rounded-0"
                                                                id="drag_button1" style="display: block;"> <i
                                                                    class="ri-arrow-right-s-line align-middle text-white "></i></button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row bg-light p-2">
                                            ...
                                            <div class="d-md-flex d-none d-md-block justify-content-between">

                                                <div class="d-flex gap-3">
                                                    <div class="">
                                                        <a href="" class="btn btn-outline-info">Mark for Review &
                                                            Next</a>
                                                    </div>

                                                    <div class="">
                                                        <a href="" class="btn btn-outline-info">Clear Response</a>
                                                    </div>
                                    ...
                                    <div>
                                            ...
                                            <div class="col-12 overflow-auto ">
                                                ...
                                                <div class="d-flex justify-content-center total-question-1 h-300px">
                                                    <div class="col-12 pt-2">
                                                        <a href="mcq.php"><button type="button"
                                                                class="btn btn-primary active p-0 mb-2">01</button></a>
                                                        <a href="paragraph.php"><button type="button"
                                                                class="btn bg-white rounded-0 mb-2 p-0 m-0">02</button></a>
                                                        <a href="multi-answer.php"> <button type="button"
                                                                class="btn bg-white rounded-0 mb-2 p-0 m-0">03</button></a>
                                                        <a href="fill-in-the-blank.php"><button type="button"
                                                                class="btn bg-white rounded-0 p-0 mb-2">04</button></a>

                                                        <a href="number-question.php"> <button type="button"
                                                                class="btn bg-white rounded-0 p-0  mb-2">05</button></a>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">06</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">07</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">08</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">09</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">10</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">11</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">01</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">12</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">13</button>
                                                        <button type="button"
                                                            class="btn btn-danger mb-2 p-0 m-0 ">14</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">10</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">11</button>
                                                        ...
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">13</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">14</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">10</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">11</button>
                                                        ...
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">10</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">17</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">01</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">12</button>
                                                        ...
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">13</button>
                                                        <button type="button"
                                                            class="btn bg-white rounded-0 mb-2 p-0 m-0">140</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-6 d-grid">
                                                <a href="exam-instruction1.php"
                                                    class="btn bg-2 fw-bold">Instructions</a>
                                            </div>
                                            <div class="col-6  d-grid">
                                            ...
                                            <div class="col-12 d-grid pt-2">
                                                ...
                                                <button href="#" class="btn bg-info text-white fw-bold" type="button"
                                                    data-bs-toggle="modal" data-bs-target="#submit_test">
                                                    Submit Test</button>
        ...
        <!--  Modal content for all questions -->

        <div class="modal fade question_list" id="submit_test" tabindex="-1" role="dialog" aria-labelledby="submit_test"
            aria-hidden="true">
                ...
                <div>
                        ...
                        <div class="col-12 overflow-auto ">
                            ...
                            <div class="d-flex justify-content-center total-question-1 h-300px">
                                <div class="col-12 pt-2">
                                    ...
                                    <a href="number-question.php"> <button type="button"
                                            class="btn bg-white rounded-0 p-0  mb-2">05</button></a>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">06</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">07</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">08</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">09</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">10</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">11</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">01</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">12</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">13</button>
                                    <button type="button" class="btn btn-danger mb-2 p-0 m-0 ">14</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">10</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">11</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">01</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">12</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">13</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">14</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">10</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">11</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">01</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">12</button>
                                    ...
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">14</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">10</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">17</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">01</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">12</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">13</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">14</button>
                                    ...
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">12</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">13</button>
                                    <button type="button" class="btn bg-white rounded-0 mb-2 p-0 m-0">140</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                        ...
                        <div class="col-12 d-grid pt-2">
                            ...
                            <button href="#" class="btn bg-info text-white fw-bold" type="button" data-bs-toggle="modal"
                                data-bs-target="#submit_test">
                                Submit Test</button>
