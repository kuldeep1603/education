                ...
                <div class="card-body rounded-3 shadow px-0 py-3">
                    <ul>
                        <li class="d-flex ms-3 mb-2  gap-3 align-items-center flex-wrap">
                            ...
                            <span class="fs-15 fw-medium text-color">Mock Test</span>
                        </li>
                    </ul>
                            ...
                            <h2 class="accordion-header" id="flush-headingOne">
                                <button class="accordion-button bg-light-card py-2 px-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#videos" aria-expanded="false" aria-controls="videos">
                                    <ul class="d-flex gap-3 align-items-center">
                                        <li>
                                            <a href="#" class="rounded-2 px-2 py-2 d-flex text-center bg-light-orange"><iconify-icon icon="solar:bill-list-bold" class="fs-25" style="color:  #ff9f1c;"></iconify-icon></a>
                                        </li>
                                        <li class="d-flex flex-column">
                                            <b class="text-color fs-15 fw-semibold">Mock</b>
        ...
        <div class="col-lg-10">
            <div class="card card-body px-3 bg-white">
                <div class="row">
                    <div class="col-12">
                        <ul>
                            <li class="d-flex  mb-2  gap-3 align-items-center flex-wrap">
                                <a href="./Course-Details.php"><i class="fa-solid fa-arrow-left-long"></i></a>
                                <span class="fs-16 fw-medium  text-color">Full Mock Test</span>
                            </li>
                        </ul>
                    </div>
                </div>
