        ...
        <div class="container-fluid">
            ...
            <div class="row row-2">
                <div class="col-md-9  left">
                    ...
                    <div class="row row-2 py-2 px-2">
                        <div class="col-lg-5 paragraph-questions-text">
                            <span class="fs-15 ">
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maxime ad aliquam aliquid eum, quas praesentium quod animi numquam porro repudiandae suscipit et consequatur cupiditate! Esse fugit et eum quos praesentium!
                            </span>
                        </div>
                        <div class="col-lg-7">
                            <div class="col-12 p-0">
                            ...
                            <div class="col-12 p-0">
                                <div class="card rounded-0 border-0 card-body py-2">
                                    <h6 class="fw-normal fs-16 mt-2">Two small drops of mercury each of radius 'R' coalesce to form a large single drop. The ratio of the total surface energies before and after the change is ?</h6>
                                    <ul class="mt-2">
                                        <li class="mt-3">
                                            <div class="form-check">
                                                <input class="form-check-input answerselect" type="radio" name="flexRadioDefault" id="answer-1">
                                                <label class="form-check-label" for="answer-1">
                                                    <span class="fs-15">Foreign Minister of Britain</span>
                                                </label>
                                            </div>
                                        </li>
                                        <li class="mt-3">
                                            <div class="form-check ">
                                                <input class="form-check-input answerselect" type="radio" name="flexRadioDefault" id="answer-2">
                                                <label class="form-check-label" for="answer-2">
                                                    <span class="fs-15">Foreign Minister of France</span>
                                                </label>
                                            </div>
                                        ...
                                        <li class="mt-3">
                                            <div class="form-check">
                                                <input class="form-check-input answerselect" type="radio" name="flexRadioDefault" id="answer-3">
                                                <label class="form-check-label" for="answer-3">
                                                    <span class="fs-15">Deputy Prime Minister of France</span>
                                                </label>
                                            </div>
                                        </li>
                                        <li class="mt-3">
                                            <div class="form-check">
                                                <input class="form-check-input answerselect" type="radio" name="flexRadioDefault" id="answer-4">
                                                <label class="form-check-label" for="answer-4">
                                                    <span class="fs-15"> None of these</span>
                                                </label>
                                            </div>
                                        </li>
                                        <li class="mt-3">
                                            <div class="form-check">
                                                <input class="form-check-input answerselect" type="radio" name="flexRadioDefault" id="answer-5">
