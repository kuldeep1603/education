...
<head>
    ...
    <title>Number Type Question</title>
...
<body>
    ...
    <section class="exam ">
        <div class="container-fluid" id="question_block">
            <div class="row row-1">
                    ...
                    <div class="row row-1">
                        ...
                        <div class="col-12 px-2 py-2">
                            <ul class="d-flex flex-wrap justify-content-between align-items-center">
                                ...
                                <li class="d-flex gap-3 align-items-center flex-wrap">
                    ...
                    <div class="row row-2">
                        ...
                        <div class="col-12 p-0">
                            <div class="card rounded-0 border-0 card-body py-2">
                                <h6 class="fw-normal fs-17 mt-2"> Two small drops of mercury each of radius 'R' coalesce to form a
                                    large single
                                    drop. The
                                        ...
                                        <div class="card">
                                            <div class="card-body bg-light">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 d-flex justify-content-center">
                                                        <div class="mt-3">
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="1">1</button>
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="2">2</button>
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="3">3</button>
                                                            <br />
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="4">4</button>
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="5">5</button>
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="6">6</button>
                                                            <br />
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="7">7</button>
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="8">8</button>
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="9">9</button>
                                                            <br>
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="0">0</button>
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value=".">.</button>
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="-">-</button>
                                                            <br />
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="left"><iconify-icon icon="mdi:arrow-up-thin" class="fs-20" style="color: white;" rotate="270deg"></iconify-icon></button>
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="right"><iconify-icon icon="mdi:arrow-up-thin" class="fs-20" style="color: white;" rotate="90deg"></iconify-icon></button>
                                                            <br />
                                                            <button class="btn bg-secondary text-white theta_btn my-1" data-value="9" style="width:100px !important;">Clear All</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <div class="calculator">
        <div class="calc-row">
            <div class="screen bg-light">0123456789</div>
        </div>
