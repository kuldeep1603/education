                    ...
                    <div class="row row-2">
                        ...
                        <div class="col-12 p-0">
                            <div class="card rounded-0 border-0 card-body py-2">
                                <h6 class="fw-normal fs-17 mt-2">Two small drops of mercury each of radius 'R' coalesce to form a large single drop. The ratio of the total surface energies before and after the change is _________?</h6>
                                <ul class="mt-2">
                                    <li class="mt-3">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="answer-1">
                                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRo49AwRQ-h0TKYFsUhF77v1h5ibXnT5i7q-QfdWRA78I5kKbRs7-SXxXl2wkxkbMJrtoI&usqp=CAU" class="img-fluid" style="width:150px" alt="">
                                            </label>
                                        </div>
                                    </li>
                                    <li class="mt-3">
